...
export class McqtestComponent implements OnInit {
  ...
  checkedoptA= false;
  checkedoptB = false;
  constructor(private sanitizer: DomSanitizer, private router: Router ,public questionsfromfirebaseService:QuestionsfromfirebaseService,@Inject(FirebaseApp) public firebaseApp: any) {
